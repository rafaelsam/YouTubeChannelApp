...
import com.example.youtb.adapters.CommentAdapter;
import com.example.youtb.models.YoutubeCommentModel;
...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private static String GOOGLE_YOUTUBE_API = "AIzaSyBS9wF7ARcIYyh_WCkBcjY0BdaFhxeIpFQ";
